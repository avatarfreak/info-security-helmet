# Fcc Challenges Info Security with Helmet js.
...
var ninetyDaysInMilliseconds = 90 _ 24 _ 60 _ 60 _ 1000;
...
## Disable DNS Prefetching - `helmet.dnsPrefetchControl()`
...
## Disable Client-Side Caching - `helmet.noCache()`
